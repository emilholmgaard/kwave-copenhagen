...
export function PlusGridRow({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-x-0 top-0 border-t border-white/20"></div>
        <div className="absolute inset-x-0 top-2 border-t border-white/20"></div>
        <div className="absolute inset-x-0 bottom-0 hidden border-b border-white/20 group-last/row:block"></div>
        <div className="absolute inset-x-0 bottom-2 hidden border-b border-white/20 group-last/row:block"></div>
      </div>
      {children}
    </div>
  )
...
export function PlusGridIcon({
  ...
  return (
    <svg
      ...
      className={clsx(
        className,
        'absolute size-[15px] fill-white/30',
        yClass,
        xClass,
      )}
    >
